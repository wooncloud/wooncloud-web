...
export const projects: Project[] = [
  {
    ...
    tags: ['Java', 'Spring Framework', 'Oracle DB', 'MyBatis', 'jQuery', 'Apache Tomcat'],
  ...
  },
  {
    ...
    tags: ['Java', 'Spring Framework', 'MyBatis', 'jQuery', 'Apache Tomcat', 'Spring Security'],
  ...
  },
  {
    ...
    tags: ['C#', 'Visual Studio', 'ASP.NET WebForms', 'MS-SQL', 'JavaScript', 'jQuery', 'Infragistics'],
    path: '/project/erp'
  },
  {
    id: 'pmis',
    ...
    tags: ['ASP', 'Visual Basic', 'C#', 'ASP.NET WebForms', 'MS-SQL', 'JavaScript', 'jQuery', 'Infragistics'],
    path: '/project/pmis'
  },
  {
    id: 'pmis-new',
  ...
  },
  {
    ...
    tags: ['Unity', 'Visual Studio', 'C#', '.NET', 'VIVE VR'],
  ...
  },
  {
    ...
    tags: ['C#', 'Unity', 'Visual Studio', '.NET', 'VIVE VR', 'Sym4d'],
  ...
  },
  {
    ...
    tags: ['C#', 'Unity', 'Visual Studio', '.NET', 'VIVE VR'],
    path: '/project/cessna'
  },
];
