                ...
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      커스텀 컬럼, 다중 하위업무, 커스텀 상태 관리 등을 지원하는
                      업무 시스템을 Preact 기반으로 리뉴얼
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      개인 및 프로젝트 캘린더를 통합하고 구글 캘린더 연동,
                      타임존, 반복일정 등을 지원하는 통합 캘린더 시스템 개발
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      OpenAI API와 Function Calling을 활용한 업무 검색 및
                      프로젝트 템플릿 생성 AI 기능 개발 및 Node.js 기반 LLM 서버
                      구축
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      환경별 다운로드 정책, IP 화이트리스트, 로그인 보안 등
                      철저한 로깅을 통한 기업 데이터 보안 체계 구축
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      다양한 요금제 생성 및 플랜별 기능 제한 매칭 시스템 개발로
                      유연한 정책 변경 및 고객 맞춤 서비스 제공
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      분산된 2개의 마스터어드민을 통합하고 고객 및 기업 관리에
                      중점을 둔 CX팀 지원 시스템 개발
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      타겟팅, 다국어 지원, 타임존 기반 예약 게시를 통한 공지사항
                      및 배너 관리 시스템 개발
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="h-full transition-all hover:shadow-lg hover:border-primary">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      SES 이메일, 퇴사자 관리, 파트너 시스템, 알림/댓글 필터, GA
                      사용자 분석, 모니터링 구축 등 서비스 안정성 및 성능 개선
                    </p>
                  </div>
                </CardContent>
              </Card>
