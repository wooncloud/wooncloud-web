      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="text-muted-foreground space-y-3">
            <p>
              ...
              했습니다. CX팀과 고객 대응팀이 원활하게 고객 지원을 할 수 있는
              통합 관리 시스템을 구축했습니다.
            </p>
          </div>
        </div>
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-muted-foreground list-disc pl-6">
            ...
            <li>
              <strong className="text-foreground">PostgreSQL 쿼리:</strong>{" "}
              시스템 전반의 데이터 및 고객·기업 정보 관리
            </li>
            <li>
              <strong className="text-foreground">Frontend UI:</strong>{" "}
              JavaScript, jQuery 기반 관리자 대시보드 및 통계 UI 구현
            </li>
          </ul>
        </div>
      </div>
