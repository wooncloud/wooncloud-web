...
export default function KyungwoonCessnaMaintenanceSimPage() {
  return (
    <ProjectPageShell
      ...
      tags={["C#", "Unity", ".NET", "Visual Studio", "VIVE VR"]}
      period="2018.10 - 2018.12 (3개월)"
    >
      <div className="w-full aspect-video">
        <iframe
          className="w-full h-full"
          src="https://www.youtube.com/embed/J5uD6_XIzyw?si=YeN-pNUKCgvaZCXJ&amp;controls=0"
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground">
          경운대학교의 세스나 경량항공기 정비 훈련 과정을 가상현실로 전환해 학습
          효율을 높이는 시뮬레이션 개발 프로젝트입니다.
        </p>
      </div>
      <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        <ul className="space-y-2 text-muted-foreground list-disc pl-6">
          <li>
            세스나 경량항공기 정비 훈련 시나리오를 VR 환경에 맞춰 재구성하고 구현
          </li>
          <li>
            60개 이상의 정비 절차 중 핵심 과정을 선별해 인터랙티브 학습 콘텐츠로
            제작
          </li>
        </ul>
      </div>
