      ...
      <div className="space-y-4">
        ...
        <div className="w-full aspect-video">
          <iframe
            ...
            src="https://www.youtube.com/embed/jw37Vd0hMY8?si=yU3C2ofM2oEdXsBe"
        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground">
            Sym4d 어트랙션 하드웨어를 연동한 블랙이글스 체험형 VR 시뮬레이션을
            구축하며 하드웨어 제어부터 콘텐츠 제작까지 전반을 이끈
            프로젝트입니다.
          </p>
        </div>
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground">
            프로젝트 구축, 편집 툴 개발, 콘텐츠 개발, 하드웨어 연동 개발,
            프로그램 시연 및 발표
          </p>
        </div>
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-muted-foreground list-disc pl-6">
            <li>
              어트랙션 하드웨어를 시뮬레이션과 동기화해 현실감 있는 비행 체험
              구현
            </li>
            <li>
              Sym4d 하드웨어 SDK를 활용해 항공기 움직임과 플랫폼 모션을 정밀하게
              매핑
            </li>
            <li>
              Bing 맵 데이터와 위성 이미지를 결합해 실제 지형과 지표를 모사한
              환경 제작
            </li>
            <li>
              항공기 편대 편집 툴과 항로 편집 에셋을 활용해 제작 효율과 연출의
              유연성 확보
            </li>
            <li>
              프로젝트 완료 후 전국 투어 시연과 발표를 통해 고객 체험 프로그램
              운영
            </li>
          </ul>
        </div>
