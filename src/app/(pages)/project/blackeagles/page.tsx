...
export default function BlackEaglesVRSimulationPage() {
  return (
    <ProjectPageShell
      ...
      tags={["C#", "Unity", ".NET", "VIVE VR", "Visual Studio", "Sym4d"]}
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          구축하며 하드웨어 제어부터 콘텐츠 제작까지 전반을 이끈 프로젝트입니다.
        </p>
      </div>
      <div className="space-y-3">
        <h3 className="text-lg font-semibold">담당 역할</h3>
        <p className="text-muted-foreground">
          프로젝트 구축, 편집 툴 개발, 콘텐츠 개발, 하드웨어 연동 개발, 프로그램
          시연 및 발표
        </p>
      </div>
      <div className="space-y-3">
        ...
        <ul className="space-y-2 text-muted-foreground list-disc pl-6">
          ...
          <li>
            Bing 맵 데이터와 위성 이미지를 결합해 실제 지형과 지표를 모사한 환경
            제작
          </li>
          <li>
