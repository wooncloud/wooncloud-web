      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="text-muted-foreground">
            <p>
              채용 공고 작성부터 지원서 접수, 전형 결과 통보까지 전 과정을
              관리할 수 있는 Spring 기반 채용 시스템을 2인 팀으로
            </p>
            <p>
              개발했습니다. 공고·지원서 모듈과 공통 서비스, 화면 구조, 형상·DB
              관리 등 전반을 맡으며 PM으로 프로젝트를 주도했습니다.
            </p>
          </div>
        </div>
        <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-muted-foreground list-disc pl-6">
            <li>
              관리자: 공고 작성·공개 여부 관리, 지원서 열람, 전형 단계 설정 및
              결과 통보 기능 구현
            </li>
            <li>
              지원자: 공개된 공고 조회, 지원서 작성, 진행 현황 확인 등 셀프
              서비스 흐름 구성
            </li>
            <li>
              Filter/AOP/Interceptor를 활용한 로그, 예외, 트랜잭션, 권한 처리를
              통한 CCC 구현
            </li>
            <li>
              MyBatis Dynamic Query와 OCP 구조로 확장성 있는 데이터 접근 계층
              설계
            </li>
            <li>
              jQuery Ajax, SweetAlert2 등으로 비동기 UI 제작 및 사용자 피드백
              향상
            </li>
