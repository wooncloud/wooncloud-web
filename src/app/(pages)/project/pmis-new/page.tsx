      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground">
            차세대 PMIS 시스템 구축을 위해 기존 서비스를 분석하고 요구사항 및
            데이터 구조를 재정의하며 UI/UX 방향성을 수립한 프로젝트입니다.
          </p>
        </div>
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-muted-foreground list-disc pl-6">
            <li>
              ...
              UI/UX와 레이아웃 디자인 컨셉 설계, Bootstrap4 기반 테마
              커스터마이징
            </li>
            <li>
              <span className="font-medium text-foreground">백엔드</span> — 기존
              시스템 분석, 요구사항 정의, 데이터베이스 테이블 정의서 작성
            </li>
          </ul>
        </div>
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-muted-foreground list-disc pl-6">
            <li>
              레거시 시스템을 정밀 분석해 신규 PMIS 구축을 위한 기능 요구사항과
              사용자 플로우를 정리
            </li>
            <li>
              부트스트랩4 기반 유료 CSS 프레임워크를 커스터마이징해 현업
              친화적인 UI 가이드라인 수립
            </li>
            <li>
              데이터베이스 테이블을 재설계하고 정의서를 작성해 향후 개발 단계의
              기준을 마련
            </li>
          </ul>
        </div>
